...
export default {
	en: {
		...
		'blog.confirm_delete': 'Confirm delete?',
		'blog.confirm_delete_message':
			'Are you sure you want to delete this blog post? This operation is permanent and cannot be reverted!',
		'blog.add_new': 'Add new post',
		'blog.editor': 'Editor',
		'blog.preview': 'Preview',
		'blog.title': 'Title',
		'blog.title_placeholder': 'Title of the blog post',

		'editor.insert_headings': 'Insert headings',
		'editor.h1': 'Heading 1',
		'editor.h2': 'Heading 2',
		'editor.h3': 'Heading 3',
		'editor.h4': 'Heading 4',
	...
	vi: {
		...
		'blog.confirm_delete': 'Xác nhận xóa?',
		'blog.confirm_delete_message':
			'Bạn có chắc chắn muốn xóa bài viết này không? Thao tác này là vĩnh viễn và không thể hoàn tác!',
		'blog.add_new': 'Thêm bài viết mới',
		'blog.editor': 'Editor',
		'blog.preview': 'Preview',
		'blog.title': 'Tiêu đề',
		'blog.title_placeholder': 'Tiêu đề của bài viết',

		'editor.insert_headings': 'Chèn tiêu đề',
		'editor.h1': 'Tiêu đề 1',
		'editor.h2': 'Tiêu đề 2',
		'editor.h3': 'Tiêu đề 3',
		'editor.h4': 'Tiêu đề 4',
