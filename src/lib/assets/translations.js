...
export default {
	en: {
		...
		'events_page.show_more': 'Show more',
		'events_page.show_less': 'Show less',
		...
		'events_page.from_age_to_age': 'From {{minAge}} to {{maxAge}} year-olds',
		'events_page.min_age': '{{minAge}}+ year-olds',
		...
		'events_page.event_title_placeholder': 'Title of the event',
		'events_page.event_start_date': 'Start date',
		'events_page.event_end_date': 'End date',
		'events_page.event_registration_link': 'Registration link',
		'events_page.event_registration_link_placeholder': 'Link to the register form',
		'events_page.event_min_age': 'Min. age',
		'events_page.event_max_age': 'Max. age',
		'events_page.event_no_age_limit': 'No age limit',
		'events_page.event_short_description_title': 'Short description',
		'events_page.event_short_description_placeholder': 'Short description for this event',
		'events_page.event_submit': 'Submit',
		...
		'blog_page.blog_post_content_placeholder': 'Content of the article',
		'blog_page.insert_heading': 'Insert heading',
		'blog_page.small_heading': 'Small heading',
		'blog_page.medium_heading': 'Medium heading',
		'blog_page.large_heading': 'Large heading',
		'blog_page.url': 'URL',
	...
	vi: {
		...
		'events_page.show_more': 'Xem thêm',
		'events_page.show_less': 'Thu gọn',
		...
		'events_page.from_age_to_age': 'Từ {{minAge}} đến {{maxAge}} tuổi',
		'events_page.min_age': 'Trên {{minAge}} tuổi',
		'events_page.past_event': 'Đã diễn ra',
		'events_page.add_new_event': 'Thêm sự kiện mới',
		'events_page.confirm_delete_event_title': 'Xóa sự kiện này?',
		'events_page.confirm_delete_event':
		...
		'events_page.event_title_placeholder': 'Tiêu đề của sự kiện',
		'events_page.event_start_date': 'Ngày bắt đầu',
		'events_page.event_end_date': 'Ngày kết thúc',
		'events_page.event_registration_link': 'Link đăng ký',
		'events_page.event_registration_link_placeholder': 'Link dẫn đến form đăng ký',
		'events_page.event_min_age': 'Độ tuổi tối thiểu',
		'events_page.event_max_age': 'Độ tuổi tối đa',
		'events_page.event_no_age_limit': 'Không giới hạn độ tuổi',
		'events_page.event_short_description_title': 'Mô tả ngắn gọn',
		'events_page.event_short_description_placeholder': 'Mô tả ngắn gọn về sự kiện',
		'events_page.event_submit': 'Lưu',
		...
		'blog_page.blog_post_content_placeholder': 'Nội dung bài viết',
		'blog_page.insert_heading': 'Chèn đầu mục',
		'blog_page.small_heading': 'Đầu mục nhỏ',
		'blog_page.medium_heading': 'Đầu mục vừa',
		'blog_page.large_heading': 'Đầu mục lớn',
		'blog_page.url': 'Đường dẫn',
