...
export default {
	en: {
		...
		'event.add_new': 'Add new event',
		'event.title': 'Title',
		'event.title_placeholder': 'Title of the event',
		'event.start_date': 'Start date',
		'event.end_date': 'End date',
		'event.registration_link': 'Registration link',
		'event.registration_link_placeholder': 'Link to the register form',
		'event.min_age': 'Min. age',
		'event.max_age': 'Max. age',
		'event.no_age_limit': 'No age limit',
		'event.short_description': 'Short description',
		'event.short_description_placeholder': 'Short description of what is the event about?',
		'event.submit': 'Submit',
	...
	vi: {
		...
		'common.ok': 'OK',
		'common.cancel': 'Hủy',
		'event.add_new': 'Thêm sự kiện mới',
		'event.title': 'Tiêu đề',
		'event.title_placeholder': 'Tiêu đề của sự kiện',
		'event.start_date': 'Ngày bắt đầu',
		'event.end_date': 'Ngày kết thúc',
		'event.registration_link': 'Link đăng ký',
		'event.registration_link_placeholder': 'Link dẫn đến form đăng ký',
		'event.min_age': 'Tuổi tối thiểu',
		'event.max_age': 'Tuổi tối đa',
		'event.no_age_limit': 'Không giới hạn độ tuổi',
		'event.short_description': 'Mô tả ngắn',
		'event.short_description_placeholder': 'Mô tả ngắn gọn nội dung của sự kiện này',
		'event.submit': 'Đăng sự kiện / Xác nhận',
